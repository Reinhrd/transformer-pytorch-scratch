...
class Seq2SeqDataModule(LightningDataModule):
    ...
    def setup(self: t.Self, stage: str) -> None:
        # batasi jumlah data kalau di-set
...
class Seq2SeqDataset(Dataset):
    """Teacher forcing untuk output, tapi dengan input juga"""
