...
class DecoderTransformerBlock(LightningModule):
    ...
    def forward(
        ...
        # hitung masked self-attention pada output
        ...
        # hitung cross-attention pakai:
        # - vektor masked-attention sebagai query
        # - output encoder sebagai key & value
        ...
        # lewatkan vektor attention ke FFN, tambah residual + layer norm
